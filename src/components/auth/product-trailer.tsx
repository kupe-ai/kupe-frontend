        ...
        <div className="flex flex-col gap-3.5 p-5 text-[16px]">
          <div
            ...
            className={cn(
              ...
              hover === "prompt" && "ring-2 bg-[#eee8f8]",
              hover === "prompt" && "ring-[#746fd1]/35",
            )}
          >
    ...
    <Win
      ...
      trailing={
        <span
          ...
          className={cn(
            "rounded-full bg-[#eee8f8] px-3 py-1 text-[13px] font-medium transition-all duration-200",
            hover === "badge" && "scale-110 ring-2 ring-[#746fd1]/25",
          )}
          style={{ color: ACCENT }}
        >
          12 today
          ...
          >
            <span
              className={cn(
                ...
                r.ok ? "bg-[#eee8f8]" : "bg-[#fff1e0] text-[#b56a1a]",
              )}
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div
            ...
            className={cn(
              ...
              hover === "trigger-0" && "scale-[1.02] border-[#746fd1]/50 bg-[#f4f1fb]",
              hover === "trigger-0" && clicked && "scale-[0.99] border-[#746fd1]",
            )}
          >
          ...
          <div
            ...
            className={cn(
              "flex items-center gap-3 rounded-xl border border-[#eeeae2] px-4 py-3 text-[15px] text-[#3f3f3e] transition-all duration-200",
              hover === "trigger-1" && "scale-[1.02] border-[#746fd1]/50 bg-[#f4f1fb]",
              hover === "trigger-1" && clicked && "scale-[0.99] border-[#746fd1]",
            )}
          >
            <span className="text-[#8a8680]">⟳</span>
        ...
        <div className="mb-2.5 flex items-center justify-between px-1.5">
          ...
          <span
            ...
            className={cn(
              ...
              hover === "add" && "scale-110 bg-[#2e2e2d] ring-2 ring-[#746fd1]/40",
      ...
      <div className="flex flex-col gap-3 p-4">
        <div
          ...
          className={cn(
            ...
            hover === "input" && "border-[#746fd1]/50 bg-white ring-2 ring-[#746fd1]/20",
            hover === "input" && clicked && "ring-[#746fd1]/40",
          )}
        >
