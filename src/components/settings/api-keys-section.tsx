                  ...
                  items={[
                    {
                      ...
                      icon: Copy,
                      onSelect: () => {
                        void navigator.clipboard.writeText(k.key_prefix);
                    ...
                    { type: "separator" },
                    {
                      ...
                      icon: Trash2,
                      variant: "destructive",
                      onSelect: () => setToDelete(k),
                    },
                  ]}
                >
                  <li className="grid cursor-context-menu grid-cols-[1fr_minmax(0,1fr)_auto_auto_auto] items-center gap-3 px-4 py-3 hover:bg-muted/40">
